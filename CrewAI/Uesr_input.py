...
# Define a Task based on user input
research_task = Task(
    description=f"Research about {user_input} and provide a summary of key findings. "
                f"Include at least 3 specific examples of recent advancements.",
    expected_output="A detailed summary with 3+ specific examples",
